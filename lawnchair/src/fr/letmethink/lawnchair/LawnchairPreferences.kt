...
import fr.letmethink.lawnchair.gestures.handlers.*
import fr.letmethink.lawnchair.globalsearch.SearchProviderController
import fr.letmethink.lawnchair.groups.AppGroupsManager
import fr.letmethink.lawnchair.groups.DrawerTabs
import fr.letmethink.lawnchair.iconpack.IconPackManager
import fr.letmethink.lawnchair.preferences.DockStyle
import fr.letmethink.lawnchair.sesame.Sesame
import fr.letmethink.lawnchair.settings.GridSize
import fr.letmethink.lawnchair.settings.GridSize2D
import fr.letmethink.lawnchair.settings.ui.SettingsActivity
import fr.letmethink.lawnchair.smartspace.*
    ...
    private fun migrateFromV1(editor: SharedPreferences.Editor, prefs: SharedPreferences) = with(
        ...
        putString("pref_gesture_double_tap",
                  when (prefs.getString("pref_dt2sHandler", "")) {
                      ...
                      "fr.letmethink.lawnchair.gestures.dt2s.DoubleTapGesture\$SleepGestureHandlerTimeout" ->
