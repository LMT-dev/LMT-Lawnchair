...
import fr.letmethink.lawnchair.gestures.ui.HandlerListAdapter
import fr.letmethink.lawnchair.gestures.ui.RunHandlerActivity
import fr.letmethink.lawnchair.settings.ui.SettingsBaseActivity
...
class LawnchairShortcutActivity : SettingsBaseActivity() {
    ...
    companion object {
        const val START_ACTION = "fr.letmethink.lawnchair.START_ACTION"
        const val EXTRA_HANDLER = "fr.letmethink.lawnchair.EXTRA_HANDLER"
